...
autograder_ping = "https://tutor.dfcs-cloud.net/versioninfo.php"
autograder_url = "https://tutor.dfcs-cloud.net/api/tutor/get_testcase.php"
scoring_url = "https://tutor.dfcs-cloud.net/api/tutor/upload_result.php"
grades_url = "https://tutor.dfcs-cloud.net/reports.php"
flag_audit = "audit"
...
def main():
    ...
    try:
        ...
        if connected:
            print("Autograder (v -UAT TEST) Contacting Server . . . ", end='')
